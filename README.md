...
This repository is maintained as an open hardware learning and reference project for SystemVerilog-based neural accelerator design. Current maintenance focuses on:

- keeping the RTL organization and design notes understandable;
- documenting verification, synthesis, and backend flow decisions;
- separating source-level material from generated EDA artifacts in future updates;
- preparing reproducible notes for ASIC and FPGA refinement work.

For planned work, see [ROADMAP.md](ROADMAP.md). For small fixes, documentation updates, or review suggestions, see [CONTRIBUTING.md](CONTRIBUTING.md).
...
- `ROADMAP.md`: Planned source, documentation, and reproducibility improvements.
- `CONTRIBUTING.md`: Lightweight contribution and issue-reporting guidance.

## Maintenance and Storage Policy

Future maintenance should avoid committing generated databases, waveform dumps, large model files, or tool cache outputs. Prefer source RTL, scripts, concise reports, checksums, and small documentation updates over raw multi-GB artifacts.
